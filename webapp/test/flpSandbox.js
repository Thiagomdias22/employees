			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employees2-display": {
								"semanticObject": "employees2",
								"action": "display",
								"description": "employees2",
								"title": "employees2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employees2",
									"url": sap.ui.require.toUrl("employees2")
								}
							}
						}
					}
